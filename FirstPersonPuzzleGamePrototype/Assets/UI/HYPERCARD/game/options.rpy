...
init -1 python hide:
    ...
    config.screen_width = 525
    config.screen_height = 371
    ...
    style.window.background = Frame("images/text.png", 12, 12)
...
python early:
    config.save_directory = "NEW YEAR-1421131403"
...
init -1 python hide:
    ...
    #Enable below to remove rollback
